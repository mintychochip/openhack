...
/// max 5 connections, a 30-second connection timeout, a 30-second
/// idle timeout, and a 30-minute max lifetime. Tests the connection on creation by acquiring and
/// immediately releasing a connection. Returns the pool on success.
///
/// # Errors
///
...
/// succeeds, indicating the database is reachable and responsive. Returns
/// the sqlx error if the query fails for any reason.
///
/// # Errors
///
